...
const AddManager = () => {
  ...
  const getSpecialityData = async () => {
    await fetch(`${import.meta.env.VITE_API_BASE_URL}/manager/getHospitals`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const deleteHospital = async (id) => {
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/admin/deleteHospital/${id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const addHospital = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/admin/registerHospital`,
        {
          method: "POST",
          headers: {
