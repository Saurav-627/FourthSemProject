...
const TableDoctor = () => {
  ...
  useEffect(() => {
    const getSpecialityData = async () => {
      await fetch(`${import.meta.env.VITE_API_BASE_URL}/manager/getHospitalSpeciality/${id}`)
        .then((res) => res.json())
        .then((data) => {
  ...
  const getDoctorData = async (doctorId) => {
    try {
      const doctor = await fetch(`${import.meta.env.VITE_API_BASE_URL}/manager/getDoctor/${doctorId}`);
  ...
  const editDoctor = async (doctorId) => {
    try {
      ...
      await fetch(`${import.meta.env.VITE_API_BASE_URL}/manager/updateDoctor/${doctorId}`, {
        method: "PATCH",
        headers: {
  ...
  const deleteDoctor = async (doctorId) => {
    try {
      await fetch(`${import.meta.env.VITE_API_BASE_URL}/manager/deleteDoctor/${doctorId}`, {
        method: "DELETE",
      });
      toast({
  ...
  const addDoctor = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/manager/createDoctor/`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
